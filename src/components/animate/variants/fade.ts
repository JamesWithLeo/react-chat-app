...
interface FadeProps {
  distance?: number;      // Distance for the animation (default is 120)
  durationIn?: number;    // Duration for the 'in' transition
  durationOut?: number;   // Duration for the 'out' transition
  easeIn?: string;      
  easeOut?: number[];     // Easing function for the 'out' transition
}
