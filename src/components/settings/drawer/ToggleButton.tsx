...
export default function ToggleButton({ notDefault, open, onToggle }: {notDefault: boolean, open: boolean, onToggle: ()=> void}) {
  return (
    <RootStyle>
      ...
      <Tooltip title="Settings" placement="left">
        ...
        >
          <Iconify icon="eva:options-2-fill" sx={{width: 20, height:20}}/>
        </IconButtonAnimate>
      </Tooltip>
    </RootStyle>
  );
